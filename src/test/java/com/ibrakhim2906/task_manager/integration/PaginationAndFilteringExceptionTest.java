...
class PaginationAndFilteringExceptionTest extends HelperIntegrationTest {
    ...
    void paginationReturnsCorrectPageSize() throws Exception {
        // User logic
        register("pagination@test.com", "password123");
        String token = login("pagination@test.com", "password123");
    ...
    void filteringReturnCorrectStatusTasks() throws Exception {
        // User logic
        register("filter_status@test.com", "password123");
        String token = login("filter_status@test.com", "password123");
        ...
        mockMvc
            ...
            .andExpect(
                jsonPath("$.content[*].status").value(
                    Matchers.everyItem(Matchers.is("DONE"))
                )
            );
    }
    ...
    void filteringReturnCorrectOverdueTasks() throws Exception {
        // User logic
        register("filter_overdue@test.com", "password123");
        String token = login("filter_overdue@test.com", "password123");
